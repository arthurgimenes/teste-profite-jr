    ...
    render() {
        return (
            <section id="sectionContentFoot">
                <section class="hiddenColum">
                    <div id="divLocation" class="row align-items-center hiddenColum">
                        <div class="col-sm">
                ...
                <div class="showColumMobile">
                    ...
                    <div class="row align-items-center">
                        <div id="divContatFoot" class="col-12">
